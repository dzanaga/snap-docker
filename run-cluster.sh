...
spark-submit --master yarn --name S1_SIGMA0_LOCAL \
            ...
            --files S1_Graph.xml,s1_postprocess.py \
            ...
            -format BEAM-DIMAP \
            -gpt S1_Graph.xml \
            -output-dir /data/sentinel_data/sentinel1/sigma0/ \
            -postprocess s1_postprocess.py /data/mep_uturn/S1/GRD/S1A_IW_GRDH_1SDV_20180329T190050_20180329T190115_021234_024845_5423.zip
